...
namespace EcommerceApp.Infrastructure.Migrations
{
    ...
    [Migration("20210626235228_DeletedCategoryNameFromProducts")]
    partial class DeletedCategoryNameFromProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Models.Order", b =>
                {
                    ...
                    b.Property<string>("ShipContactEmail")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Models.Employee", b =>
                {
                    b.HasOne("EcommerceApp.Domain.Models.ApplicationUser", "AppUser")
                        .WithOne("Employee")
                        .HasForeignKey("EcommerceApp.Domain.Models.Employee", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EcommerceApp.Domain.Models.ApplicationUser", null)
                        .WithMany()
